# 📘 Workbook 3 — Agile, GitHub Management & Java Fundamentals  
...
## 💡 Core Concepts
- 🌀 **Agile Principles** — iterative development, customer focus, responding to change  
- 📝 **User Stories** — structured requirement statements supporting planning & collaboration  
- 📋 **Kanban Boards** — visual task management using GitHub Projects  
- 🌿 **Version Control with GitHub** — collaboration, branches, pushes & pulls  
- 📁 **File I/O** — reading and writing files using Scanner, BufferedReader, FileWriter  
- 🕒 **Java Dates** — LocalDate, LocalTime, LocalDateTime, formatting & parsing  
- 📦 **Collections** — ArrayList and HashMap for storing and managing data  
- 🧪 **Problem Solving** — applying fundamentals through CodeWars challenges  
